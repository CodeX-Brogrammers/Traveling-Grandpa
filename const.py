...
START_ANSWER = Text(
    src="\n".join([
        ...
        """Если ты захочешь узнать больше о нашем задании, скажи "помощь". А если тебе интересны способы нашего общения просто спроси: "Что ты умеешь?". А может у тебя появится что-то важное и тебе нужно будет остановить нашу беседу, просто скажи "Выход" - я всегда пойму.\n""",
    ...
    tts="".join([
        "<speaker audio='dialogs-upload/69d87e76-1810-408c-8de1-4951ad218fa6/57371dd8-f3cc-48c5-9013-732fa9614f01.opus'>",
